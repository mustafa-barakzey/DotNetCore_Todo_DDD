...
namespace brk.Framework.Tools.Extensions
{
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// نامی که بالای پراپرتی ها میزاریم رو بر میگردونه اگه وجود داشته باشه
        /// </summary>
        /// <param name="property"></param>
        /// <returns></returns>
        public static string DisplayName(this PropertyInfo property)
        {
            var attrbutes = property.GetCustomAttributes(typeof(DisplayNameAttribute), true);

            if (attrbutes.Any() && attrbutes[0] is DisplayNameAttribute attr) return attr.DisplayName;
            return "";
        }
